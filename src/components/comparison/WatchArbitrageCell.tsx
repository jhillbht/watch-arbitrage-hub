...
const WatchArbitrageCell = ({ arbitrage }: WatchArbitrageCellProps) => {
  ...
  return (
    <div className="bg-purple-950/30 backdrop-blur-sm border border-purple-900/50 rounded-lg p-3">
      <div className="text-center">
        ...
        <div className="font-medium text-purple-400 text-lg">{formatCurrency(arbitrage.profit)}</div>
